...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) => UserData(
    ...
    customFieldInputValues: CustomFieldInputValues.fromJson(json["customFieldInputValues"]),
  );
...
class CustomFieldInputValues {
  ...
  factory CustomFieldInputValues.fromJson(Map<String, dynamic> json) => CustomFieldInputValues(
  );
